...
## Introduction
As requirement, we need to implement for one component: Quiz Participation, Score Updates, and Leaderboard. The repository is service what structured to implement features for Quiz Service (Quiz Participation, Score Updates components). In this repo, it's includes:

- Clearn architecure
- Config logs, connect to DB
- Docker Compose
- Kafka Broker
- gRPC
- Lint
